...
export async function action({ request }: Route.
  ActionArgs) {
  ...
  return (
    <main className="grid lg:grid-cols-2 gap-8 lg:gap-12 lg:h-screen px-6 xl:max-w-6xl mx-auto">
      <div className="lg:self-center">
        ...
        <Link to="/signup" className=" mt-4 text-gray-300 inline-block hoover:underline"> Dont have an account ? sign up instead</Link>
      </div>
      <div>
        <img
